	...
	protected boolean doDecode(IoSession session, IoBuffer buffer, ProtocolDecoderOutput out) throws Exception {
		...
		if (msgSize >= 4) {
			...
			try {
				...
				String headers = new String(headerBytes, Constant.CHARSET);
				...
				BasicIncomingPacket incomingPacket = new BasicIncomingPacket();
				String data = null;
				...
				if (length > msgSize) {
					...
					if (contentLength > 0) {
						...
						data = new String(dataBytes, Constant.CHARSET);
					}
